    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="page-header" class="page-header">
                ...
                <div id='cssmenu' class="col-md-18">
                    <ul>
                        ...
                        <li class='active'><a href='Help'><span>Pomoc</span></a></li>
            ...
            <div class="col-md-12" style="padding: 15px">
                ...
                <div>
                    <a href="<?php echo $this::$assetsPath; ?>/files/Instrukcja.pdf" target="_blank">Instrukcja użytkownika</a>
                    <br>  <br> 
                    <a href="<?php echo $this::$assetsPath; ?>/files/Regulamin.pdf" target="_blank">Regulamin platformy e-pracownik</a>
                </div>
            </div>
        </div>
